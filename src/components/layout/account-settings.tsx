...
import { EditUserMutation, EditUserMutationVariables } from "@/graphql/types";
...
export const AccountSettings = ({ opened, setOpened, userId }: Props) => {
  ...
  const { saveButtonProps, formProps, queryResult } = useForm<
    ...
    GetVariables<EditUserMutationVariables>
  >({
    /**
    ...
    meta: {
      ...
      gqlMutation: EDIT_USER_MUTATION,
    },
  });
        ...
        <Card>
          <Form {...formProps} layout="vertical">
            ...
            <Form.Item label="Access Level" name="accessLevel">
              <Input placeholder="Access Level" disabled={true} />
            </Form.Item>
          </Form>
          <SaveButton
            {...saveButtonProps}
